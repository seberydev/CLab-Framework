...
//	void DrawBounds() {
//		int boundSize{ 10 };
//		clf::Render::DrawFillRect({ 0, 0, boundSize, 600 }, { 255, 255, 255, 255 });
//		clf::Render::DrawFillRect({ 600 - boundSize, 0, boundSize, 600 }, { 255, 255, 255, 255 });clf::Render::DrawFillRect({ 600 - boundSize, 0, boundSize, 600 }, { 255, 255, 255, 255 });
//		clf::Render::DrawFillRect({ 0, 0, 600, boundSize }, { 255, 255, 255, 255 }); clf::Render::DrawFillRect({ 600 - boundSize, 0, boundSize, 600 }, { 255, 255, 255, 255 });
//		clf::Render::DrawFillRect({ 0, ScreenHeight() - boundSize, 600, boundSize }, { 255, 255, 255, 255 }); clf::Render::DrawFillRect({ 600 - boundSize, 0, boundSize, 600 }, { 255, 255, 255, 255 });
//	}
//};
